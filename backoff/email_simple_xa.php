...
verifsessionadmin();
	...
	$message .="Dans le cadre de la 7e édition du \"Répertoire92\" réalisé par la Direction Académique des Hauts-de-Seine sur le thème \"Toiles\", vous avez la possibilité de télécharger 11 fichiers audio (chants et play-backs de la maternelle au collège) accompagnés des paroles et de ressources pédagogiques.\n\n";
	...
	$message .="ATTENTION: Ce téléchargement est possible jusqu'au 30 juin 2016.\n\n";
	$message .="Pour toute question, contacter Marc Laugenie :\n";
	$message .="marc.laugenie@ac-versailles.fr";
	
	mail($email,'repertoire Traverses 92, Edition 2015 : Toiles', $message, $headers);
